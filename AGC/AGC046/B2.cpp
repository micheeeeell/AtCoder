...
const ll c_max = 3030, d_max = 3030;
vector<vector<mint>> dp(c_max, vector<mint>(d_max));
vector<vector<ll>> flag(c_max, vector<ll>(d_max));
ll c, d;
mint dfs(ll i, ll j){
    if(i == c && j == d) return 1;
